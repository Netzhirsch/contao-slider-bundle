...
//        $stmt = $conn->prepare($strQuerySelect);
//        $result = $stmt->execute($dc->id, $breakpoint);
//        $found = $result->fetchAssoc();
//        if (empty($found))
//            return $value;
//        if (
//            ($dc->field == 'nh_xs_arrows' && $found[$fieldInDatabase] == 'inherited')
//            || ($dc->field == 'nh_xs_centerMode' && $found[$fieldInDatabase] == 'inherited')
//            || ($dc->field == 'nh_xs_dots' && $found[$fieldInDatabase] == 'inherited')
//        ) {
//            return 'show';
//        }
//        return $found[$fieldInDatabase];
//    }
//
